...
read_dat = False
#first_bit = 1.5
#hole_bit = 1.5 #if no hole then ignore
...
max_z = 10
min_z = -4
first_bit = job0.end_mills_in_use[0]
...
if len(jobs) > 1:
    ...
    output_name = '{}_{}'.format(output_folder, first_bit)
else:
    output_folder = job0.folder
    output_name = '{}_{}'.format(job0.folder, first_bit)
